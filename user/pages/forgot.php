...
if(isset($_POST["submit"]))
{
    ...
    //echo "Submit Click ";
    $validate_user_information = mysqli_query($connection,"select * from `user` where `username` = '".mysqli_real_escape_string($connection,$name)."' ");
    ...
    if(mysqli_num_rows($validate_user_information) == 1) //Check if the information of the user are valid or not
        {
            ...
            if(mysqli_query($connection,"update `user` set `password`='$encpassword' where username='$name'"))
                {
